...
<script type="text/javascript">
	function xx(){
		$("#imgVcode").prop("src","${pageContext.request.contextPath}/yzm?time="+new Date().getTime());
	}
</script>
</head>
<body>
			...
			<div class="wrap clearfix">
				<div id="J_loginDiv">
					<form action="${pageContext.request.contextPath}/back/login" method="post">
						<span style="color:red;font-size: 21px;margin-left: 45px;">${sessionScope.zt}</span>
						<div id="J_loginCoreWrap" class="infro">
							<div class="username" id="username_div">
								<span></span> <input class="user" id="txtUsername" name="a.username" type="text" />
							...
							<div class="password" id="password_div">
								<span></span> <input class="pass" id="txtPassword" name="a.password" type="password" />
							</div>
							<br /> <br />
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
											<img id="imgVcode" src="${pageContext.request.contextPath}/yzm" class="Ucc_captcha Captcha-image" onClick="changeImage()">
											
										</a>
										<a id="vcodeImgBtn" name="change_code_link" class="code_picww" href="javascript:xx()">换张图</a> 
