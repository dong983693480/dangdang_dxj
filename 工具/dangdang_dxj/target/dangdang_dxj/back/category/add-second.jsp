...
<html>
  ...
  <body style="background-color: #f0f9fd;">
  	...
  	<form action="${path}/tjej" method="post">
		所属一级类别:		
		<select name="de" class="el-select__inner">
			<c:forEach var="a" items="${all}">
				<option value="${a.cate_name}">${a.cate_name}</option>
			</c:forEach>
		</select>
  		<br/><br/>
  		二级类别名:<input class="el-input__inner" type="text" name="c.cate_name" id="sname"/><br/><br/>
