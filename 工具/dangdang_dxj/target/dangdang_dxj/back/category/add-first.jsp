...
<html>
  ...
  <body style="background-color: #f0f9fd;text-align: center">
  	...
  	<form action="${pageContext.request.contextPath}/insertOne" method="post">
  		类别名:<input class="el-input__inner" type="text" name="c.cate_name" id="fname"/><span id="fnameMsg"></span><br/><br/>
