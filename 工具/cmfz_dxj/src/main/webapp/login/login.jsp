    ...
    <script>
        $(function(){
            ...
            $("#captchaImage").click(function(){
                $("#captchaImage").prop("src","${path}/admin/x1?"+new Date().getTime());
            });

            //表单验证
            $.extend($.validator.messages, {
                required: "<span style='color:#ff00ff' >这是必填字段</span>",
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/login" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/x1">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="yzm1" id="form-code">
                            </div>
